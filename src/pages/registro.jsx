...
function Form({formStep, userType, nextFormStep, prevFormStep}) {
  ...
  return userType === 'lawyer' ? (
    <>
      ...
      <Transition appear={true} className='absolute bottom-60 w-full px-4 flex justify-center' show={formStep > 0} enter='transition-opacity duration-500 delay-200' leave='transition-opacity duration-300' enterFrom='opacity-0' enterTo='opacity-100' leaveFrom='opacity-100' leaveTo='opacity-0'>
